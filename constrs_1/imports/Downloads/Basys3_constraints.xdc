...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {data_changed_debug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data_changed_debug}]
#set_property PACKAGE_PIN E19 [get_ports {enable_debug}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {enable_debug}]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {STEP}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {STEP}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {DIR}]					
...
###Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {PMOD[3]}]					
